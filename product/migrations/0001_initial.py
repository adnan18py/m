    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_posts', models.ManyToManyField(to='post.post')),
                ('related_products', models.ManyToManyField(blank=True, to='product.products')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.products')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
